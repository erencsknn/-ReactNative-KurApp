...
const KurHesapla = ({ }) => {
    ...
    (
        <View style = {{ alignItems:'center', backgroundColor: '#000000', height : 600, width : 400}}>
            ...
            <Text style ={{fontSize : 20, color : '#cae1ff',marginLeft: 55,marginBottom:60,fontStyle:'italic'}} >TRY-KUR Dönüştürücü</Text>
            ...
            <TextInput style = {styles.input} placeholder ='ÇEVİRİLECEK TRY TUTARI YAZINIZ.' onChangeText={(newValue) => { setcikti((newValue /er).toFixed(2))}}></TextInput>
            
            <Text style = {styles.input} > {cikti} </Text>
